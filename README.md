...
- ### Project Objective and Overview
  - #### Project Objective:
    This project aims to classify the category of a news entry based on its summary and short description. In particular, the goal is to classify the category of $ith$ news entry $Y_i$ into exactly one category from $K$ categories, in which $Y \subseteq K$, based on a vector of word embeddings from the concatenated headline short description of that news entry $X_i$.
  - #### Project Overview:
