...
- ### Data Structure
  This dataset contains 209,527 entries, with each entry representing one news entry, and six columns, with each column representing features related to that particular news entry. The columns, along with a snapshot of the dataset, are depicted in the table below.
